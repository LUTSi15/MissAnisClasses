                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="card h-100 border-0 shadow-sm">
                                            <div class="card-body">
                                                <h6 class="card-title text-uppercase text-muted small">Class Information
                                                </h6>
                                                <div class="d-flex align-items-center mt-3">
                                                    <i class="fas fa-users fa-2x text-primary me-3"></i>
                                                    <div>
                                                        <h5 class="mb-0">{{ $student->classroom->name }}</h5>
                                                        <p class="text-muted mb-0">Year {{ $student->classroom->year }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="card h-100 border-0 shadow-sm">
                                            <div class="card-body">
                                                <h6 class="card-title text-uppercase text-muted small">Personal Details
                                                </h6>
                                                <ul class="list-unstyled mt-3">
                                                    ...
                                                    <li>
                                                        ...
                                                        <span>Ambition:
                                                            {{ $student->ambition ?? 'Not Specified' }}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <table class="table table-hover">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <i class="fas fa-pen text-warning" data-bs-toggle="tooltip"
                                                title="Writing"></i>
                                        </th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @php
                                                    ...
                                                    $average =
                                                        count($scores) > 0 ? array_sum($scores) / count($scores) : 0;
                                                @endphp
                                                <span
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    <div class="me-3">
                                                        <span
                                                            ...
                                                            <i
                                                                class="fas fa-{{ $att->is_present ? 'check' : 'times' }}"></i>
                                                        </span>
                                                    </div>
                                                    <div>
                                                        <p class="mb-0 fw-medium">
                                                            {{ date('l', strtotime($att->date)) }}</p>
                                                        <small
                                                            class="text-muted">{{ date('d M Y', strtotime($att->date)) }}</small>
                                                    </div>
                                                    <div class="ms-auto">
                                                        <span
                                                            class="badge bg-{{ $att->is_present ? 'success' : 'danger' }}">
                                ...
                                <div class="text-center mt-3">
                                    <a href="#" class="btn btn-sm btn-outline-primary">View Full Attendance
                                        History</a>
                                </div>
                            </div>
                                ...
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span>Absent:</span>
                                            <span class="text-danger fw-bold">{{ $totalDays - $presentDays }}
                                                days</span>
                                        </div>
                                    </div>
                                </div>
