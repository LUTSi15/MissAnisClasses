                            ...
                            <div class="card-body p-0">
                                ...
                                {{-- <div class="d-flex justify-content-end mb-3">
                                    <div class="btn-group" role="group">
                                        <button id="batchActionBtn" type="button"
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="batchActionBtn">
                                            <li><a class="dropdown-item batch-action" data-action="increase"
                                                    href="#">Increase Selected</a></li>
                                            <li><a class="dropdown-item batch-action" data-action="decrease"
                                                    href="#">Decrease Selected</a></li>
                                        </ul>
                                    </div>
                                </div> --}}
                                <div class="table-responsive">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="rating-card">
                                                                                <div class="level-indicator mb-2">
                                                                                    <span
                                                                                        class="badge rounded-pill {{ $colorClass }}-bg">Level->{{ $level }}({{ $levelName }})
                                                                                        <span
                                                                                            class="ms-2 text-muted small">{{ $starsToShow }}/20
                                                                                            flames</span>
                                                                                </div>
